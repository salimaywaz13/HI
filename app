        ...
        Settings { EmptyView() }
            .commands {
                ...
                CommandGroup(after: .appInfo) {
                    Button(String(localized: "Check for Updatesâ¦", bundle: _appLocalizedBundle)) {
                ...
                CommandGroup(replacing: .appSettings) {
                    Button(String(localized: "Settingsâ¦", bundle: _appLocalizedBundle)) {
...
final class AppDelegate: NSObject, NSApplicationDelegate, NSPopoverDelegate, NSWindowDelegate {
    ...
    @objc private func handleClick(_ sender: NSStatusBarButton) {
        ...
        if event.type == .rightMouseUp {
            ...
            // â¥-click momentarily reveals the technical-details view,
    ...
    private func showMenu(from button: NSStatusBarButton) {
        ...
        menu.addItem(.init(title: String(localized: "Settingsâ¦", bundle: _appLocalizedBundle), action: #selector(menuSettings), keyEquivalent: ","))
        for builder in PluginRegistry.shared.nsMenuItemBuilders[.statusItemMenu] ?? [] {
            menu.addItem(builder())
        }
        menu.addItem(.init(title: String(localized: "Check for Updatesâ¦", bundle: _appLocalizedBundle), action: #selector(menuCheckUpdates), keyEquivalent: ""))
        let testKitItem = NSMenuItem(
            title: String(localized: "Contribute Diagnostic Dataâ¦", bundle: _appLocalizedBundle),
